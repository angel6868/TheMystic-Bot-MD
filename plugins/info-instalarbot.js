...
- git clone https://github.com/Angeldzn/Adriel-Bot-MD
-MD.git && cd TheMystic-Bot-MD
- yarn install
- npm install
- npm update
- npm start
...
> npm start`.trim();
  const buttonMessage= {
    'document': {url: `https://github.com/Angeldzn/Adriel-Bot-MD`},
    ...
    'contextInfo': {
      ...
      'isForwarded': true,
      'externalAdReply': {
        'mediaUrl': 'https://github.com/Angeldzn/Adriel-Bot-MD',
        'mediaType': 2,
        'previewType': 'pdf',
